...
export default function Unidentified() {
    ...
    const loadSpots = async () => {
        try {
            const result = await axios.get(`${process.env.REACT_APP_API_URL}/api/unidentified?page=${page}&size=12`, {
                headers: {
            ...
            <div className="container">
                <nav aria-label="breadcrumb" className='mt-3'>
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Unidentified spots</li>
                    </ol>
                </nav>
